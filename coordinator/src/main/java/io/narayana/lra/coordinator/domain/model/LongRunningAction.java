...
public class LongRunningAction extends BasicAction {
    ...
    /**
     * Construct a new LongRunningAction using an externally supplied uid.
     * When {@code externalUid} is null or blank the behaviour matches the
     * four-argument constructor — the uid is generated by Narayana. When a
     * non-blank uid is provided, it is passed straight to the Narayana
    ...
    public LRAParticipantRecord enlistParticipant(URI coordinatorUrl, String participantUrl, String recoveryUrlBase,
        ...
        if (lock == null) {
            ...
            try {
                ...
                if (participant != null) {
                    FailureFlags.exitIfEnabled(FailureFlags.FailurePoint.JOIN_BEFORE_DEACTIVATE);
                    ...
                    if (deactivate()) { // if it fails the superclass will have logged a warning
                        ...
                        FailureFlags.exitIfEnabled(FailureFlags.FailurePoint.JOIN_AFTER_DEACTIVATE);
                    } else {
                        throw new ServiceUnavailableException(LRALogger.i18nLogger.warn_saveState(DEACTIVATE_REASON));
                    }
                } else {
    ...
    public boolean forgetParticipant(String participantUrl) {
        ...
        // deactivate() persists the updated pending list so that other coordinators (HA)
        // and recovery see the participant as removed and do not call @Compensate/@Complete.
        if (removed != null && !deactivate()) {
